	...
	return (
	   <div className='faq'>
			...
			<div className='content-part border'>
				...
				<div className='d-row middle' style={{gap: 5}}>
					...
					<p className='medium-text'>
						Is .ARB only for storing an dotarb address?
					</p>
				</div>
				...
				<p className='small-text'>
					...
					Instead, we suggest hosting your static html/css/images on IPFS and put the hash in your .ARB name's Content record. Then it can be resolved by .ARB-aware browsers (e.g. Opera), browser extension (Metamask), or any browser with ".link" or ".limo" appended to the end (e.g. matoken.eth.link or matoken.eth.limo).
			...
			<div className='content-part border'>
				...
				<p className='small-text'>
				This happen occasionally when the USD price changes and you haven't registered with enough ARB. Please try again from step 3.
				</p>
				<p className='small-text'>
				...
				<p className='small-text'>
				This occasionally happen when OpenSea is under a heavy load. You may also not find your name under the NFT section of your wallet, as many wallets fetch metadata from OpenSea.
				</p>
				<p className='small-text'>
			...
			<div className='content-part border'>
				...
				<p className='small-text'>
				If your ARB address is set as the Controller you can change the resolver and add/edit records. Some dapps (eg: Fleek, OpenSea) set themselves as the Controller so they can update records on your behalf.
				</p>
				<p className='small-text'>
			...
			<div className='content-part'>
				...
				<div className='d-row middle' style={{gap: 5}}>
					<div className='symbol'></div>
					<p className='medium-text'>
					What happen if I forget to extend the registration of a name?
					</p>
				</div>
				<p className='small-text'>
